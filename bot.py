...
def send_emails(admin_id):
    global sent_counts, failed_emails, last_send_times, admin_data, bot, sending_active, sent_emails, email_sent_counts, email_send_times
